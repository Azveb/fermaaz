    ...
    >
      ...
      <div className="relative w-full bg-gray-50 overflow-hidden" style={{ aspectRatio: "4/3" }}>
        ...
        <button
          ...
          disabled={loading}
          className={`absolute top-2 right-2 w-8 h-8 rounded-full bg-white/70 backdrop-blur-md border border-white/40 flex items-center justify-center shadow-sm transition-all duration-300 hover:bg-white hover:scale-110 active:scale-95 ${
      ...
      {/* Info */}
      <div className={`flex-1 flex flex-col ${compact ? "p-2.5 gap-0.5" : "p-3 gap-1"}`}>
