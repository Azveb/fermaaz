...
export async function POST(request) {
  ...
  const { items, couponCode, shippingAddress, shippingRegion, shippingCity } = parsed.data;
  ...
  try {
    ...
    const [code, detail] = message.includes(":") ? message.split(":") : ["ERROR", message];
    const statusMap = { STOCK: 409, COUPON: 400, ERROR: 500 };
