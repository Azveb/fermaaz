...
async function findStore(id) {
  // Allow lookup by id or slug for convenience
  return prisma.store.findFirst({ where: { OR: [{ id }, { slug: id }] } });
}
...
export async function PATCH(request, { params }) {
  ...
  // Only admin may toggle verification / active state directly via extra fields
  const extra = {};
  if (isAdmin) {
