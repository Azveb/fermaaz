...
export const metadata = {
  title: 'Əlaqə | FermerMarket',
  description: 'FermerMarket komandası ilə əlaqə saxlayın.',
};
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-xl shadow-gray-200/50 border border-white h-full">
              ...
              {/* Form is standard HTML without external agent dependencies */}
              <form className="space-y-5" action="/api/contact" method="POST">
                ...
                <button 
                  type="submit" 
                  className="w-full bg-brand-600 hover:bg-brand-700 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-brand-500/30 transition-all hover:-translate-y-0.5 active:scale-95 flex items-center justify-center gap-2"
                >
